...
from tgn.utils.data_processing import (
...
parser.add_argument(
    "--memory_dim", type=int, default=172, help="Dimensions of the memory for each user"
)
parser.add_argument(
    "--different_new_nodes",
    action="store_true",
...
def get_checkpoint_path(epoch):
    return (
        f"./saved_checkpoints/{args.prefix}-{args.data}-{epoch}"
        + "\
  node-classification.pth"
    )
